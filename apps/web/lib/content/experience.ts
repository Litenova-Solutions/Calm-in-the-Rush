  ...
  screens: [
    {
      ...
      tiles: [
        ...
        prefilledVideoTile(
          'nature-lake',
          'Bergmeer',
          'Zonsopgang boven een mistig meer omringd door groen.',
          'Er is ruimte voor dit moment.',
          '/media/experience/nature-lake.webm',
          '/media/experience/nature-lake-poster.jpg',
          '/media/experience/audio-lake.mp3',
          {
        ...
        uploadTile('nature-upload', 'Voeg een natuurfoto toe', 'Een plek waar je even stilstaat.'),
      ],
    },
    {
      id: 'quiet-moments',
      ...
      tiles: [
        ...
        uploadTile('quiet-upload', 'Voeg een stil moment toe', 'Je eigen stille moment.'),
      ],
    },
    {
      id: 'friendly-faces',
