...
A person selects a visible upload tile in Nature, Quiet Moments, or Relaxed Faces.
...
- Show every configured upload tile. Completing one upload must not hide a second Relaxed Faces upload option.
